---
name: create-variant
description: Create an independent dashboard, chatbot, or other derivative of this PostgreSQL base starter while preserving the shared setup, authentication, UI, and AI conventions.
---
