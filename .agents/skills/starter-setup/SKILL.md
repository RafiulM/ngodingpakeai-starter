---
name: starter-setup
description: Prepare this PostgreSQL starter on the first app-building prompt, or fix first-run dependency, Docker, environment, and migration problems so the user can build immediately.
---
